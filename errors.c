...
void    print_error(int numerror)
{
    if (numerror == (-1))
        ...
        printf("in -NO- no adress(2th argument)");
    else if (numerror == (-35))
        printf("in -SO- no adress(2th argument)");
    else if (numerror == (-36))
        printf("in -WE- no adress(2th argument)");
    else if (numerror == (-37))
        printf("in -EA- no adress(2th argument)");
    else if (numerror == (-38))
        printf("in -Sprite- no adress(2th argument)");
    else if (numerror == (-39))
        printf("in -R- not 3 arguments");
    else if (numerror == (-40))
        printf("in -F- not 3 arguments");
    else if (numerror == (-41))
        printf("in -C- not 3 arguments");
    else if (numerror == (-42))
        printf("map not valid");
    else if (numerror == (-43))
        printf("after map not end");
    else if (numerror == (-44))
        printf("2 player location on the map");
    else if (numerror == (-45))
        printf("in map bad arguments");
    exit(1);
}
